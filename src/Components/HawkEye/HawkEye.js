...
import hawk from '../../Assets/hawk-eye.png'
import { motion } from 'framer-motion';
import { useEffect , useState} from 'react'


const HeroId = '1009338'
...
function HawkEye (){
    ...
    return(
        ...
        <div className='general-div'>
            <div className='spiderman-img-mobile hulk-img hawk-background'>
                <motion.h1 
                initial={{ y: -330 }}  animate={{ y: 0  }} transition={{ type: "spring", delay: 0.5 }}> {datos.name} </motion.h1>
                
                
                    <motion.img src={hawk} alt="Hulk"  animate={{ y: 800 }} transition={{ type: "spring", stiffness: 100 }}  />
                    
                <div className='general-info-div hawk-info-div'>
                        <motion.h2 initial={{ x: 1000 }}  animate={{ x: 0  }} transition={{ type: "spring", delay: 0.3 }}  >Story</motion.h2>
                            <motion.p initial={{ opacity: 0 }}  animate={{ opacity: 1  }} transition={{ type: "spring", duration:2 }}>Clint Barton was born in Waverly, Iowa. At a young age he lost both of his parents in a car crash. After six years in an orphanage, Clint and his brother Barney Barton ran away to join the Carson Carnival of Traveling Wonders. Clint soon caught the eye of the Swordsman, who took the young boy on as his assistant.</motion.p>
                </div>

            </div> 
        </div>
        <div className='general-comics hawk-comics'>
            <h2 >Comics</h2>
